...
var slideWrap = document.querySelector('.sub_1container'),
slideContainer = document.querySelector('.sub_1slider-container'),
slides = document.querySelectorAll('.sub_1slide'),
...
timer,
pagerHTML = '',
pagers = document.querySelector('.sub_1pager'), 
...
var pagerBtn = document.querySelectorAll('.sub_1pager span');
...
function goToSlide(idx) {
    slideContainer.classList.add('sub_1animated');
